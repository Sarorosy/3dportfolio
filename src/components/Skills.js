  ...
  <span className="flex-1 h-[1px] bg-gray-800 ml-4"></span>
      ...
      <div className="skill-category mb-8">
        ...
        <p className="text-lg text-gray-400">
          HTML, CSS, JavaScript, PHP, jQuery, AJAX, React, Node.js, Express, MySQL, MongoDB, REST APIs, Postman, Deployment
        </p>
      </div>
      ...
      <div className="skill-category mb-8">
        ...
        <p className="text-lg text-gray-400">
          Bootstrap, Tailwind CSS, UI Animations, Optimizations, Prototyping, Frontend Frameworks (CodeIgniter, Laravel)
        </p>
      </div>
      ...
      <div className="skill-category mb-8">
        ...
        <p className="text-lg text-gray-400">
          Visual Studio Code, cPanel, Git, Firebase, SEO, WordPress, API Integrations, Postman
        </p>
      </div>
